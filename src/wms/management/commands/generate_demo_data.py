...
EMAILS = ["alex.shevchenko@example.com", "maria.koval@example.com", "ivan.bondar@example.com", "olena.melnyk@example.com", "dmytro.kravchenko@example.com"]
ROLES = [ROLE_CHOICES.MANAGER, ROLE_CHOICES.SELLER, ROLE_CHOICES.WORKER, ROLE_CHOICES.MANAGER, ROLE_CHOICES.SELLER]

CATEGORY_NAMES = ["Електроніка", "Одяг", "Іграшки", "Канцелярія", "Продукти"]
PRODUCT_NAMES = [
    "Смартфон", "Ноутбук", "Планшет", "Навушники", "Монітор", "Клавіатура", "Миша", "Принтер", "Флешка", "Камера",
    "Футболка", "Джинси", "Куртка", "Сорочка", "Плаття", "Шорти", "Кросівки", "Капці", "Шкарпетки", "Шапка",
    "М'яка іграшка", "Конструктор", "Пазл", "Машинка", "Лялька", "Настільна гра", "Кубик Рубіка", "Пластилін", "Фломастери", "Книга",
    "Зошит", "Ручка", "Олівець", "Лінійка", "Гумка", "Папка", "Щоденник", "Клей", "Скотч", "Маркер",
    "Молоко", "Хліб", "Сир", "Ковбаса", "Йогурт", "Яблуко", "Банан", "Картопля", "Морква", "Помідор"
]
